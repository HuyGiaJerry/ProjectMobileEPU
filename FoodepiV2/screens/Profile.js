...
const ProfileScreen = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.name}>Rownok</Text>
      <Text style={styles.lastname}>Mahbub</Text>
      ...
      <View style={styles.card}>
        <View style={styles.cardRow}>
          ...
          <View style={styles.cardContent}>
            ...
            <Text style={styles.cardValue}>Rownok Mahbub</Text>
          </View>
          <TouchableOpacity>
      ...
      <View style={styles.card}>
        <View style={styles.cardRow}>
          ...
          <View style={styles.cardContent}>
            ...
            <Text style={styles.cardValue}>rownok2001@gmail.com</Text>
          </View>
          <TouchableOpacity>
            <Image source={require('../assets/edit.png')} style={{ width: 24, height: 24 }} />
          </TouchableOpacity>
        ...
        <View style={styles.cardRow}>
          ...
          <View style={styles.cardContent}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <Text style={styles.cardValue}>0188074710</Text>
